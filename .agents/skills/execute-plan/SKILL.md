...
expected. Handle it based on impact:

- **Small adjustment** (naming, ordering within a task): Handle it and
  briefly note what changed in the plan.
...
- Don't add extra features, refactors, or "improvements" after
  completing the plan. Done means done.
- Don't rewrite working code that isn't part of the plan, even if you
  think it could be better.
- Don't add dependencies (npm packages, pip packages, etc.) without them
  being in the plan or getting explicit approval.
...
- Don't skip the plan's verification section.
