...
- Linter: `ruff check .` (config in `ruff.toml`). Also available via `make lint`. ~681 pre-existing violations (mostly UP006/UP045 type-annotation modernizations and F821 undefined names); none are blockers.
