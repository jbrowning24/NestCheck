...
**Author:** Jeremy Browning **Date:** February 17, 2026 **Status:** Draft v2.0 (Research-Informed Revision) **Stage:** Pre-seed / Solo founder
...
> [!important] STRATEGIC DECISION **Decision:** Consumer product as primary identity. B2B permitted only where partner incentives align with honest evaluation. MLS/brokerage partnerships excluded. **Rationale:** Consumer-only companies in this space die from distribution and monetization failures. But B2B that requires softening insights kills the product's core value. The middle path: consumer-facing brand with aligned B2B revenue.
...
_"I just want to build things that nobody can take from me."_
