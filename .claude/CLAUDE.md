...
| 2026-03 | Renamed "Third Place" → "Coffee & Social Spots" (NES-210) | Academic jargon ("third place") was inaccessible. Internal Tier2Score name now matches display name, fixing weight badge lookup bug. Old snapshots migrated via `_migrate_dimension_names()` |
