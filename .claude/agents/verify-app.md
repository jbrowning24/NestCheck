...
3. **Template rendering**: Check that all Jinja templates parse without errors by running `python -c "from app import app; app.jinja_env.get_template('<name>')"` for key templates.
